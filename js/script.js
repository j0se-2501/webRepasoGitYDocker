...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('ejercicioAnterior').addEventListener('click', function () {
    ...
    document.getElementById('ejercicioSiguiente').addEventListener('click', function () {
    ...
    function showExercise(exerciseNumber) {
        hideAllCards();
        document.getElementById('ejercicio' + exerciseNumber).classList.remove('d-none');
        updateButtonsVisibility();
    }
